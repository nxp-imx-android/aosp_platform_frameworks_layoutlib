...
public class RemoteRenderResourcesAdapter implements RemoteRenderResources {
    ...
    @Override
    public boolean themeIsParentOf(RemoteResourceValue<StyleResourceValue> parentTheme,
            RemoteResourceValue<StyleResourceValue> childTheme) {
        return mDelegate.themeIsParentOf(parentTheme.toResourceValue(),
                childTheme.toResourceValue());
    }
